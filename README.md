...
I plan on updating the code to support all 4 architectures on both supported editions eventually.

# Building

You will need Visual Studio 2022 or 2026 with the UWP and C++ workloads installed.

Currently build 25931 is targeted for the Windows SDK, if it asks to retarget then picking 22621 should work fine, any version below that is untested.
